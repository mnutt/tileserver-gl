...
export function getPublicUrl(publicUrl, req) => publicUrl || `${req.protocol}://${req.headers.host}/`;

export function getTileUrls = (req, domains, path, format, publicUrl, aliases) => {
  if (domains) {
...
export function getFontsPbf = (allowedFonts, fontPath, names, range, fallbacks) => {
