...
const defaultMbtilesUrl = 'https://github.com/maptiler/tileserver-gl/releases/download/v1.3.0/zurich_switzerland.mbtiles';
...
async function downloadDefaultMbtilesFile() {  
  ...
  console.log(`[DEMO] Downloading sample data (${defaultMbtilesFilename}) from ${defaultMbtilesUrl}`);
